...
export function Chatbot() {
  ...
  return (
    <div
      className={`fixed z-50 bg-gradient-to-br from-slate-900/95 to-slate-950/95 backdrop-blur-xl border border-white/20 shadow-2xl flex flex-col transition-all duration-300 ${
        isFullscreen
          ? "inset-0 rounded-none"
          : "bottom-4 right-4 sm:bottom-6 sm:right-6 w-[calc(100vw-2rem)] sm:w-[600px] h-[calc(100vh-6rem)] sm:h-[750px] rounded-2xl"
      }`}
    >
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-5 space-y-4">
        {messages.map((msg, idx) => (
          ...
          >
            <div
              className={`max-w-[85%] rounded-2xl px-4 md:px-5 py-3 ${
                msg.role === "user"
