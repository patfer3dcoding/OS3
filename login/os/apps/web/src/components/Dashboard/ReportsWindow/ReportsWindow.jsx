...
export function ReportsWindow() {
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      // Add white background for better capture
      ...
      pdf.save(`recruitment_report_${reportType}_${Date.now()}.pdf`);
            ...
            {reportTemplates.map((template) => {
              ...
              return (
                <div
                  ...
                  className={`p-5 rounded-xl border-2 cursor-pointer transition-all duration-300 transform hover:scale-105 ${reportType === template.id
