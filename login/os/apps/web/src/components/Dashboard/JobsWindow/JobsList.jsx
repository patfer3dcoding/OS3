    ...
    <div className="w-80 border-r border-white/10 flex flex-col bg-white/5">
      <div className="p-4 border-b border-white/10 space-y-3">
        ...
        <div className="flex gap-2">
          <button
            onClick={onExport}
            className="px-4 py-2 bg-green-500 hover:bg-green-600 rounded-lg text-white text-sm font-medium transition-all"
            title="Export CSV"
          >
          ...
          <button
            onClick={onAddNew}
            className="flex-1 h-10 bg-purple-500 hover:bg-purple-600 rounded-lg text-white font-medium flex items-center justify-center gap-2 transition-all"
          >
        ...
        {isLoading ? (
          ...
          jobs.map((job) => (
            <button
              ...
              className={`w-full p-4 border-b border-white/10 text-left transition-all hover:bg-white/10 ${selectedJob?.id === job.id ? "bg-white/15" : ""
                }`}
            >
